...
- 1 arcmin ≈ the approximate limit of human visual acuity.
  ...
  - Mizar and Alcor are separated by 11 arcmin. They were an ancient test of visual acuity. I can see them separated in the night sky, but my eyes are dark-adapted. And that means I'm seeing with the rod cells of my eyes, not the cone cells. Those rod cells do have a higher angular resolution, but they are relegated to the periphery of the fovea. And so it seems a lower quality of visual acuity despite their higher resolution. (And no color sensation!) You often have to view with averted vision.
